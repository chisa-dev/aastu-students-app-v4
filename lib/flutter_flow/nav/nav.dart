...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      errorBuilder: (context, state) => entryPage ?? NavBarPage(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => entryPage ?? NavBarPage(),
        ),
        FFRoute(
          name: 'login',
          path: '/login',
        ...
        FFRoute(
          name: 'QuizGenerator',
          path: '/QuizGenerator',
          builder: (context, params) => QuizGeneratorWidget(
        ...
        FFRoute(
          ...
          path: '/store',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Store')
              : StoreWidget(),
        ),
        FFRoute(
          name: 'StoreItemUpload',
          path: '/storeItemUpload',
          builder: (context, params) => StoreItemUploadWidget(),
        ),
        FFRoute(
          name: 'StoreItemDetail',
          path: '/storeItemDetail',
          asyncParams: {
            'item': getDoc(['store_items'], StoreItemsRecord.fromSnapshot),
          },
          builder: (context, params) => StoreItemDetailWidget(
        ...
        FFRoute(
          name: 'MyStoreItems',
          path: '/myStoreItems',
          builder: (context, params) => MyStoreItemsWidget(),
        ),
        FFRoute(
          name: 'QuizPracticeRoom',
          path: '/QuizPracticeRoom',
          builder: (context, params) => QuizPracticeRoomWidget(
            id: params.getParam(
              'id',
              ParamType.int,
            ),
