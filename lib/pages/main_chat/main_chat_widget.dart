...
import '/components/chat_list_shimmer/chat_list_shimmer_widget.dart';
                            ...
                            Expanded(
                              child: StreamBuilder<List<ChatsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  if (!snapshot.hasData) {
                                    return ChatListShimmerWidget(itemCount: 5);
                                  }
                                                    ...
                                                    return Padding(
                                                      ...
                                                      child: FutureBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          if (!snapshot
                                                              .hasData) {
                                                            return ChatListShimmerWidget(itemCount: 1);
                                                          }
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child: BlurHashNetworkImage(
                                                                                ...
                                                                                blurHash: rowUsersRecord.photoBlurHash,
                                                                                width: 44.0,
                                                                                height: 44.0,
                                                                                fit: BoxFit.cover,
                                                                                shape: BoxShape.circle,
