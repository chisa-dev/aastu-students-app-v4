                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    await launchURL('https://t.me/codeitlab');
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                                    mainAxisAlignment:
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'This app is open source! Help us make it better.',
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            if (!AnonymousUserService().isAnonymous)
                              Align(
                                alignment: AlignmentDirectional(0.0, -1.0),
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      FFAppState().QuizCollectionData = [];
                                      FFAppState().update(() {});
                                      await Future.delayed(
                                          const Duration(milliseconds: 500));
                                      GoRouter.of(context).prepareAuthEvent();
                                      await PushNotificationService()
                                          .cleanupForUser(currentUserUid);
                                      await authManager.signOut();

                                      // Sign in anonymously after logout
                                      await AnonymousUserService()
                                          .signInAnonymously();
                              ...
                              child: RichText(
                                ...
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: _model
                                          .getDeviceInfoResult!.appVersion,
                                      style: TextStyle(),
                                    ),
                                    TextSpan(
                                      text: '  Build No. ',
                                    ...
                                    TextSpan(
                                      text: _model
                                          .getDeviceInfoResult!.buildNumber,
                                      style: TextStyle(),
                                    )
                                  ],
                                  style: FlutterFlowTheme.of(context)
