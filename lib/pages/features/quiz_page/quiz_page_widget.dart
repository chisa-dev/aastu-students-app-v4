          ...
          child: Scaffold(
            ...
            floatingActionButton: Visibility(
              ...
              child: FloatingActionButton(
                onPressed: () async {
                  context.pushNamed('QuizGenerator');
                },
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(16.0, 18.0, 0.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          InkWell(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                32.0, 8.0, 32.0, 0.0),
                            child: Text(
                              'Create multiple-choice questions based on course topics to enhance your study. Powered by Gemini AI.',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                final quizCollectionList = FFAppState()
                                    .QuizCollectionData
                                    .toList()
                                    .take(50)
                                    .toList();
                                if (quizCollectionList.isEmpty) {
                                  return EmptyListQuestionsWidget();
                                }
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: quizCollectionList.length,
                                  itemBuilder:
                                      (context, quizCollectionListIndex) {
                                    final quizCollectionListItem =
                                        quizCollectionList[
                                            quizCollectionListIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 8.0, 0.0, 0.0),
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            ...
                                            queryParameters: {
                                              'id': serializeParam(
                                                quizCollectionListItem.id,
                                                ParamType.int,
                                              ),
                                              'questionName': serializeParam(
                                                quizCollectionListItem.title,
                                                ParamType.String,
                                              ),
                                            }.withoutNulls,
                                          );
    ...
    return InkWell(
      ...
      onTap: () async {
        context.pushNamed(
          'QuizGenerator',
          queryParameters: {
            'courseName': serializeParam(courseName, ParamType.String),
            'content': serializeParam(content, ParamType.String),
          }.withoutNulls,
        );
      },
      child: Container(
