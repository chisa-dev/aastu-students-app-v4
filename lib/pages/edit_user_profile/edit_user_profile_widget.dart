                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                                  .departmentTextController1 ??=
                                              TextEditingController(
                                            text: editUserProfileUsersRecord
                                                .department,
                                          ),
                                          focusNode:
                                              _model.departmentFocusNode1,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                                  .departmentTextController2 ??=
                                              TextEditingController(
                                            text: editUserProfileUsersRecord
                                                .batch,
                                          ),
                                          focusNode:
                                              _model.departmentFocusNode2,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode: _model.collegeFocusNode,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText: 'College',
                                            labelStyle:
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await currentUserReference!
                                  ...
                                  department:
                                      _model.departmentTextController1.text,
                                  batch: _model.departmentTextController2.text,
                                  collage: _model.collegeTextController.text,
                                  phoneNumber:
