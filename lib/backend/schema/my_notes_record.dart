...
class MyNotesRecord extends FirestoreRecord {
  ...
  // "remind_before" field.
  int? _remindBefore;
  int get remindBefore => _remindBefore ?? 15;
  bool hasRemindBefore() => _remindBefore != null;
  ...
  void _initializeFields() {
    ...
    _remindBefore = castToType<int>(snapshotData['remind_before']);
...
class MyNotesRecordDocumentEquality implements Equality<MyNotesRecord> {
  ...
  bool equals(MyNotesRecord? e1, MyNotesRecord? e2) {
    return e1?.uid == e2?.uid &&
        ...
        e1?.remindBefore == e2?.remindBefore &&
